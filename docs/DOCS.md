...
Recovered from published Artifacts on 2026-09-21; no copy existed on this
machine before.
...
Published from the second account (`~/.claude-ninacn`). Copied down 2026-09-21.

| File | What it is | Published |
|---|---|---|
| `ECE4760_pico-2-bench-notes.html` | Lecture shorthand from Hunter Adams' class, filled in: how a Pico 2 program starts, reading the SDK, GPIO/SIO/registers, run vs debug mode, and what Lab 1 needs from SPI, timer interrupts and the DAC. 51 KB | `claude.ai/artifact/QtQZA3gX7C9LHTYjXa2mrs` |
